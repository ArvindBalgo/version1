...
$cata_ligne_params->delByIdCataLigne($cata->getIdBack());

$cata_ligne = new cata_ligne();
$cata_ligne->delete($cata->getIdBack());
$cata_ligne->delete($cata->getIdFront());

$cata_metier = new cata_metier();
$cata_metier->deleteIdCata($cata->getId_Cata());
//end delete
